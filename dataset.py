...
def build_dataset(args):
    ...
    if args.dataset == 'Kvasir':
        ...
        return train_dataset, test_dataset, nb_classes, n_channels
        ...
        train_dataset = DataClass(split='train', transform=train_transform, download=True, as_rgb=True, root=args.data_dir, size=224, mmap_mode='r')
        test_dataset = DataClass(split='test', transform=test_transform, download=True, as_rgb=True, root=args.data_dir, size=224, mmap_mode='r')
        val_dataset = DataClass(split='val', transform=test_transform, download=True, as_rgb=True, root=args.data_dir, size=224, mmap_mode='r')
        return train_dataset, val_dataset, test_dataset, nb_classes, n_channels
    else:
...
def build_transform(args):
    ...
    t_train.append(transforms.RandomHorizontalFlip(p=0.5))
    # t_train.append(transforms.RandomVerticalFlip(p=0.5))
    # t_train.append(transforms.RandomRotation(10))
